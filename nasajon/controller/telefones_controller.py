...
GET_ROUTE = f'/{APP_NAME}/{MOPE_CODE}/telefones/<id>'
LIST_POST_ROUTE = f'/{APP_NAME}/{MOPE_CODE}/telefones'
...
def get_telefones():
    with InjectorFactory() as factory:
        try:
            ...
            service = factory.telefones_service()
